...
public class ProductProcessingFunctionTest
{
    ...
    public ProductProcessingFunctionTest()
    {
        ...
        _enqueueTaskAction = new EnqueueTask(_queueServiceMock.Object);

        _function = new ProductProcessingFunction(_loggerMock.Object, _createProductAction, _uploadImageAction, _updateProductAction, _enqueueTaskAction);
    }
